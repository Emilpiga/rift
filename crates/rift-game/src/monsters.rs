...
use rift_engine::ecs::components::{AnimationSet, EnemyKind};
...
impl MonsterRole {
    pub fn from_kind(kind: EnemyKind) -> Self {
        match kind {
            EnemyKind::Brute => MonsterRole::Brute,
            EnemyKind::Stalker => MonsterRole::Stalker,
            EnemyKind::Caster => MonsterRole::Caster,
        }
    }
