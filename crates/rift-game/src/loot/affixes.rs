...
pub const AFFIX_POOL: &[AffixDef] = &[
    ...
    AffixDef {
        id: "pct_minion_damage",
        name_template: "{} Minion Damage",
        effect: AffixEffect::Stat(Stat::MinionDamage),
        roll: (0.06, 0.12),
        ilvl_scale: 0.004,
        tags: SUMMON | CASTER,
        min_ilvl: 1,
    ...
    AffixDef {
        id: "pct_minion_health",
        name_template: "{} Minion Health",
        effect: AffixEffect::Stat(Stat::MinionHealth),
        roll: (0.08, 0.16),
        ilvl_scale: 0.005,
        tags: SUMMON | DEFENSE | UTILITY,
        min_ilvl: 1,
        rarity_min: Rarity::Magic,
        weight: 45,
    },
    ...
    AffixDef {
        id: "pct_minion_attack_speed",
        name_template: "{} Minion Attack Speed",
        effect: AffixEffect::Stat(Stat::MinionAttackSpeed),
        roll: (0.04, 0.08),
        ilvl_scale: 0.0025,
        tags: SUMMON | SPEED,
        min_ilvl: 5,
    ...
    AffixDef {
        id: "pct_summon_duration",
        name_template: "{} Summon Duration",
        effect: AffixEffect::Stat(Stat::MinionDuration),
        roll: (0.08, 0.15),
        ilvl_scale: 0.0035,
        tags: SUMMON | UTILITY,
        min_ilvl: 5,
